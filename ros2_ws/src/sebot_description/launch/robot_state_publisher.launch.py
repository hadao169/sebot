...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'sebot/ros2_ws/src/sebot_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_ws/install/sebot_description/share/sebot_description/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='sebot',
...
def generate_launch_description():
    ...
    # Define filenames
    urdf_package = 'sebot_description'
    urdf_filename = 'rosmaster_x3.urdf.xacro'
    rviz_config_filename = 'sebot_description.rviz'
