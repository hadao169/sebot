...
def generate_launch_description():
    ...
    package_name_gazebo = 'sebot_gazebo'
    package_name_localization = 'sebot_localization'
    package_name_navigation = 'sebot_navigation'

    # Launch and config file paths
    apriltag_launch_file_path = 'launch/apriltag_dock_pose_publisher.launch.py'
    gazebo_launch_file_path = 'launch/sebot.gazebo.launch.py'
